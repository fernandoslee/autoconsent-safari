...
Evaluates a code snippet in the context of the page. The rule is considered successful if it _evaluates to a truthy value_. Snippets have to be explicitly defined in [snippets.ts](/lib/eval-snippets.ts).
